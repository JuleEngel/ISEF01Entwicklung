...
CREATE TABLE `nachrichten` (
  ...
  KEY `nachrichten_ibfk_1` (`user_id`),
  KEY `nachrichten_ibfk_2` (`question_id`),
  CONSTRAINT `nachrichten_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `nachrichten_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `fragenkatalog` (`id`)
